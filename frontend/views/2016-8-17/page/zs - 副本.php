...
<div class="products-top">
    ...
    <div class="container">
        ...
        <div class="products-top-grids wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
            ...
            <div class="col-md-12 products-grid">
                <h1 class="text-center" style="color: #ff6b5c; margin-bottom: 50px;  margin-top:50px;">传统水果店与拼一下相比</h1>
                <img src="/images/z2.jpg" class="img-responsive">
                <div class="clearfix"> </div>
            </div>
            <div class="col-md-12 products-grid">
                <h1 class="text-center" style="color: #39969a; margin-bottom: 50px;  margin-top:50px;">传统电商与拼一下相比</h1>
                <img src="/images/z3.jpg" class="img-responsive">
                <div class="clearfix"> </div>
            </div><div class="col-md-12 products-grid">
                <h1 class="text-center" style="color: #ff6b5c;  font-size:50px;margin-bottom: 20px; margin-top:50px;">合伙人收益分析</h1>
        ...
        <div class="products-top-grids wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
            <h1 class="text-center" style="color: #ff6b5c;  font-size:50px;margin-bottom: 20px; margin-top:50px;">市场开拓</h1>
